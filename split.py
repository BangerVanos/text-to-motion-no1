...
limit_train_files = 5000   # например, 2500 файлов для обучения (1250 пар)
limit_test_files  = 5000   # 2500 файлов для теста (1250 пар)
limit_val_files   = 1000    # 500 файлов для валидации (250 пар)
