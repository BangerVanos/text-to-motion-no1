...
def render(motions, mesh_path: str, outdir='test_vis', device_id=0, name=None, pred=True):
    ...
    j2s = joints2smpl(num_frames=frames, device_id=0, cuda=True, mesh_path=mesh_path)
